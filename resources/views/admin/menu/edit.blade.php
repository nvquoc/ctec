                    ...
                    <form action="admin/menu/sua/{{ $menu->id }}" method="POST">
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                <h3 class="card-title float-left">Sửa Liên Kết</h3>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="label" value="{{ old('label') ? old('label') : $menu->label }}" required placeholder="Nhập tên liên kết...">
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="url" value="{{ old('url') ? old('url') : $menu->url }}" required placeholder="Nhập liên kết https://...">
                                </div>
                            </div>
                            <!-- /.card-body -->
                            <!-- /.card-footer -->
                            <div class="card-footer">
                                ...
                                <a href="admin/menu" class="btn btn-default float-right">Hủy bỏ</a>
                            </div>
                            <!-- /.card-footer -->
                        </div>
                        <!-- /.card -->
                                    ...
                                    <ol class="dd-list">
                                        ...
                                        <li class="dd-item dd3-item" data-id="{{ $menu->id }}">
                                            ...
                                            <div class="dd3-content">
                                                ...
                                                <span class="float-right mr-2 ml-2"><a href="admin/menu/xoa/{{ $menu->id }}" onclick="return confirm('Xác nhận xóa?');"><i class="fa fa-trash text-danger"></i></a></span>
                                            ...
                                            <ol class="dd-list">
                                                ...
                                                <li class="dd-item dd3-item" data-id="{{ $sub->id }}">
                                                    ...
                                                    <div class="dd3-content">
                                                        ...
                                                        <span class="float-right mr-2 ml-2"><a href="admin/menu/xoa/{{ $sub->id }}" onclick="return confirm('Xác nhận xóa?');"><i class="fa fa-trash text-danger"></i></a></span>
                                                        <span class="float-right mr-2 ml-2">|</span>
                                                    ...
                                                    <ol class="dd-list">
                                                        ...
                                                        <li class="dd-item dd3-item" data-id="{{ $s->id }}">
                                                            ...
                                                            <div class="dd3-content">
                                                                {{ $s->label }}
                                                                <span class="mr5 ml-5"><a href="{{ $s->url }}"
                                                                        target="_blank">{{ $s->url }}</a></span>
                                                                <span class="float-right mr-2 ml-2"><a href="admin/menu/xoa/{{ $s->id }}" onclick="return confirm('Xóa liên kết sẽ xóa luôn các liên kết con!\nXác nhận xóa?');"><i class="fa fa-trash text-danger"></i></a></span>
                                                                <span class="float-right mr-2 ml-2">|</span>
