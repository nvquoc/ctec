...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Thêm Trang</h1>
                </div><!-- /.col -->
                <div class="col-sm-12">
    ...
    <div class="content">
        <div class="container-fluid">
            <form action="admin/trang/them" method="POST">
                @csrf
                <div class="row">
                    <div class="col-sm-9">
                        <div class="card card-info">
                            ...
                            <div class="card-body">
                                <div class="form-group mb-5">
                                    ...
                                    <input class="form-control" type="text" name="name" value="{{ old('name') }}" required placeholder="Nhập tên trang...">
                                </div>
                                <div class="form-group mb-5">
