...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid">
            <form action="admin/baiviet/sua/{{ $post->id }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-sm-9">
                        <div class="card card-info">
                            ...
                            <div class="card-body">
                                <div class="form-group mb-5">
                                    ...
                                    <input class="form-control" type="text" name="title" value="{{ (old('title')) ? old('title') : $post->title }}" required placeholder="Nhập tiêu đề bài viết...">
                                </div>
                                <div class="form-group mb-5">
                                    ...
                                    <textarea class="form-control tinymce" name="content" cols="30" rows="30">{{ (old('content')) ? old('content') : $post->content }}</textarea>
                                </div>
                            </div>
                            <!-- /.card-body -->
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <select class="form-control" name="status">
                                        <option value="0" {{ old('status', $post->status) == 0 ? 'selected' : '' }}>Lưu Nháp</option>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <select class="form-control" name="is_hot">
                                        <option value="0" {{ old('is_hot', $post->is_hot) == 0 ? 'selected' : '' }}>Không</option>
                                        <option value="1" {{ old('is_hot', $post->is_hot) == 1 ? 'selected' : '' }}>Có</option>
                                    </select>
                                </div>
                                <div class="form-group mb-4">
                                    ...
                                    <img class="img-rounded img-fluid mb-3" src="upload/images/baiviet/{{ $post->image }}" id="wizardPicturePreview" alt="" style="width: 300px; height: 300px;">
