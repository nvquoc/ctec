...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid">
            <form action="admin/nguoidung/them" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-sm-5">
                        <div class="card card-info">
                            ...
                            <div class="card-body">
                                <div class="form-group text-center mb-4">
                                    ...
                                    <p><img src="http://placehold.it/300x300?text=avatar"
                                            class="img-circle img-thumbnail img-fluid" id="wizardPicturePreview"
                                ...
                                <div class="form-group mb-5">
                                    ...
                                    <input type="text" class="form-control" name="name" value="{{ old('name') }}" required placeholder="Nhập họ và tên người dùng...">
                                </div>
                            </div>
                            <!-- /.card-body -->
                        </div>
                            ...
                            <div class="card-body">
                                <div class="form-group mb-4">
                                    ...
                                    <select class="form-control" name="rule">
                                        <option value="0" @if (old('rule') == 0) {{ "selected" }} @endif>Thành viên</option>
                                        <option value="1" @if (old('rule') == 1) {{ "selected" }} @endif>Admin</option>
                                    </select>
                                </div>
                                <div class="form-group mb-4">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input type="password" class="form-control" name="passwordAgain" required placeholder="Nhập lại mật khẩu...">
                                </div>
                            </div>
                            <!-- /.card-body -->
                            <!-- /.card-footer -->
