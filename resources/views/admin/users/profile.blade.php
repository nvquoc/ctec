...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid">
            <form action="admin/hoso" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-sm-5">
                        ...
                        <div class="card card-info">
                            ...
                            <div class="card-body">
                                <div class="form-group mb-4">
                                    ...
                                    <select class="form-control" name="rule" disabled>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <input type="email" class="form-control" name="email" value="{{ $user->email }}" disabled placeholder="Nhập địa chỉ email...">
                                </div>
                                <div class="form-group mb-4">
                                    <label for="">Mật khẩu (Để trống nếu không thay đổi)</label>
                                    <div class="text-danger mb-2">
